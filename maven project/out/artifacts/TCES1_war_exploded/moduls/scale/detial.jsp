...
<div class="edit-content">
	<div class="content">
	<p>角色名：<span style="color:blue;">${requestScope.scale.scaleName}</span></p>
	<p>功能：<span style="color:blue;"><c:if test="${!empty requestScope.actions}">
				<c:forEach items="${requestScope.actions}" var="sca">
					${sca.actionName}&nbsp;&nbsp;
				</c:forEach>
			</c:if>
	</span></p>
