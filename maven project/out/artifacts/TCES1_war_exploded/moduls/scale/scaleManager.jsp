...
function gotoUserDetail(uid){	
	var url = "/TCES1/lookingActionAction?id="+uid;
	console.log(url);
...
$(document).ready(function(){
	$('#dg_scale').datagrid({
	    ...
	    columns:[[
	        ...
	        {field:'id',title:'操作',width:200,align:'center',
	            formatter: function(value,row,index){
	              ...
	              //	'<a href="/TCES1/lookingActionAction?id='+ row.id+'">功能查看</a>'
	             }
	       }
	    ]],   
	    ...
	    toolbar: [{
            ...
            handler: function() {
               //移除存在的Dialog
            	...
            	//创建窗口
            	createModalDialog("dialog_add","/TCES1/findActionAction","添加角色", 600,450);
	   ...
	   handler: function() {
		   ...
		   $.ajax({  
               url : "/TCES1/scalelistSearchAction?filter="+filter+"",
