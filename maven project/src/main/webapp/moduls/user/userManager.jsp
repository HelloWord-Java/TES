...
<%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn"%>
 <%
	...
	if (session.getAttribute("scale") == null) {
...
function gotoUserDetail(uid){	
	var url = "/TCES1/lookingScaleAction?id="+uid;
	console.log(uid);
...
$(document).ready(function(){	
	$('#dg_user').datagrid({
	    ...
	    columns:[[
	        ...
	        {field:'classId',title:'班级',width:200,align:'left'},
	        {field:'depId',title:'院系',width:200,align:'left'},
	    ...
	    toolbar: [{
            ...
            handler: function() {
               //移除存在的Dialog
            	...
            	createModalDialog("dialog_add","/TCES1/findScaleAction","添加用户", 500, 350);
            ...
            handler: function() {
                ...
                {  
	            	...
	            	//创建窗口
	            	//修改用户
	            	createModalDialog("dialog_edit","findSecondScaleAction?id="+rowId+"","修改用户", 500, 350,'icon-modify',_buttons);
                             ...
                             $.ajax({  
                                 ...
                                 success : function(r) {  
                                     ...
                                     if (r.success && r.success>0) {  
                                     	$('#dg_user').datagrid('acceptChanges');  
                                         $.messager.show({  
                                             msg : r.msg,  
                                             title : '成功'  
                                         });  
    	   ...
    	   handler: function() {
    		   ...
    		   $.ajax({  
                   url : "/TCES1/userlistSearchAction?filter="+filter+"",
                   success : function(data){
                	   $('#dg_user').datagrid('loadData', JSON.parse(data));
                   }
               });
    	   }
       }]
